...
1. Upload the entire `tabs-responsive` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Go to Tabs Responsive Panels menu to customize this plugin.
4. Copy your publish Tabs shortcode and then paste into your page or post to display it.
...
1. Tabs with icon 
2. Tabs with different color 
3. Tabs with margin/space
4. Right Align Tabs 
5. Vertical tabs with left align
6. Vertical tabs with right align
7. Tabs with image content
8. Tabs with youtube and music content
9. Tabs Drag and drop feature
10. Tabs settings panel
...
= 1.5.6 25-May-16 =
* Add Some Comments For Developer
* Small Bug Fixed
* Compatible With WordPress 4.5.2 version 

= 1.5.5 30-Apr-16 =
* Resolved custom css single line display issue. 
